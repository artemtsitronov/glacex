...
impl Theme {
    ...
    pub const DARK: Theme = Theme {
        ...
        text_muted: Color {
            ...
            b: 140.0 / 255.0,
            a: 1.0,
        }, // #83838c (Zinc 450 — readable on #111116 surface)
        success: Color {
            r: 34.0 / 255.0,
            g: 197.0 / 255.0,
            b: 94.0 / 255.0,
    ...
    pub const CATPPUCCIN_MOCHA: Theme = Theme {
        ...
        text_muted: Color {
            ...
            b: 178.0 / 255.0,
            a: 1.0,
        }, // #9399b2 (Subtext 1 — clearly readable on dark mocha surface)
        success: Color {
            r: 166.0 / 255.0,
            g: 227.0 / 255.0,
            b: 161.0 / 255.0,
    ...
    pub const TOKYO_NIGHT: Theme = Theme {
        ...
        text_muted: Color {
            ...
            b: 196.0 / 255.0,
            a: 1.0,
        }, // #9aa0c4 (Comment-level, ~4.5:1 contrast on storm surface)
        success: Color {
            r: 158.0 / 255.0,
            g: 206.0 / 255.0,
            b: 106.0 / 255.0,
    ...
    pub const GRUVBOX_DARK: Theme = Theme {
        ...
        text_muted: Color {
            ...
            b: 132.0 / 255.0,
            a: 1.0,
        }, // #a89984 (fg4 — clearly readable on gruvbox dark charcoal)
        success: Color {
            r: 184.0 / 255.0,
            g: 187.0 / 255.0,
            b: 38.0 / 255.0,
    ...
    pub const ROSE_PINE: Theme = Theme {
        ...
        text_secondary: Color {
            ...
            b: 184.0 / 255.0,
            a: 1.0,
        }, // #a09db8 (Subtle boosted — readable on rose-pine surface)
        text_muted: Color {
            r: 122.0 / 255.0,
            g: 119.0 / 255.0,
            b: 148.0 / 255.0,
            a: 1.0,
        }, // #7a7794 (Muted boosted — clearly visible on dark base)
        success: Color {
            r: 156.0 / 255.0,
            g: 207.0 / 255.0,
            b: 216.0 / 255.0,
